...
const Button = ({BtText,imgPath,pressed})=>{
    ...
    return(
        <TouchableOpacity onPress={handlePress} style={{shadowColor:"#AEAEC0",shadowOpacity:0.25,elevation:20,shadowRadius:20,shadowOffset:{width:5,height:5},display:"flex",justifyContent:"center",alignItems:"center",width:"100%",backgroundColor:"#FFF",borderRadius:100,marginBottom:20}}>
